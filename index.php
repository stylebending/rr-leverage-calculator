        ...
        <div class="card shadow-xl mb-3 panel panel-default">
          ...
          <div class="card-body panel-body">
            <form id="my-form" class="p-5 mb-10">
              <div class="flex">
                <div id="error" class="invisible alert alert-error"></div>
              </div>
              <div class="flex">
                <div id="resdata" class="invisible alert alert-info"></div>
              </div>
              Entry
              <div class="flex">
        ...
        <div class="card shadow-xl mb-3 panel panel-default">
          ...
          <div class="card-body panel-body">
            <form id="lev-form" class="p-5 mb-10">
              <div class="flex" id="levrow">
                <div class="flex">
                  <div id="levdata" class="invisible alert alert-info"></div>
                </div>
              ...
              <div class="flex">
                <button type="submit" class="m-2 btn btn-primary shadow-xl">
          ...
          <div class="card-body panel-body">
            <form id="tp-form" class="p-5 mb-10">
              <div class="flex" id="tprow">
                <div id="tpdata" class="invisible alert alert-info"></div>
              </div>
              <div class="flex">
              ...
              <div class="flex">
                ...
                <button type="button" class="add-tp-fields m-2 btn btn-success shadow-xl">
